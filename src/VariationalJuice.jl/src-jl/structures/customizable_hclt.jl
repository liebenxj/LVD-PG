using Graphs: SimpleGraph, bfs_tree, center, add_edge!, outneighbors
using MetaGraphs
using ProbabilisticCircuits: bottom_up_order
using ProbabilisticCircuits: PlainInputNode


function customized_hclt(clt_edges, num_hidden_cats; get_leaf_pcs::Function, 
